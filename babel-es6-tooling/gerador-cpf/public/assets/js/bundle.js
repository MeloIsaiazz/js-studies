...
button:hover {
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,2BAA2B;EAC3B,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,sCAAsC;EACtC,kBAAkB;EAClB,YAAY;EACZ,iBAAiB;EACjB,aAAa;EACb,eAAe;EACf,YAAY;EACZ,gBAAgB;EAChB,gBAAgB;AAClB;;AAEA;EACE,eAAe;AACjB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  display: flex;\n  flex-direction: column;\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 36px;\n  border-radius: 10px;\n  text-align: center;\n  align-items: center;\n  gap: 12px;\n}\n\nform input, form label, form button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n}\n\nform button:hover {\n  background: var(--primary-color-darker);\n}\n\nh1 {\n  padding: 0;\n}\n\n.cpf-gerado {\n  font-size: 52px;\n  text-align: center;\n  color: var(--primary-color);\n  margin-bottom: 12px;\n}\n\nbutton {\n  color: white;\n  background-color: var(--primary-color);\n  border-radius: 8px;\n  height: 44px;\n  padding: 8px 12px;\n  outline: none;\n  font-size: 16px;\n  border: none;\n  font-weight: 500;\n  min-width: 100px;\n}\n\nbutton:hover {\n  cursor: pointer;\n}"],"sourceRoot":""}]);
// Exports
...
var GeraCPF = /*#__PURE__*/function () {
  ...
  return _createClass(GeraCPF, [{
    ...
    key: "genNewCpf",
    value: function genNewCpf() {
      var rawCpf = this.rand();
      var digit1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(rawCpf);
      var digit2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].geraDigito(rawCpf + digit1);
      var newCpf = rawCpf + digit1 + digit2;
      return newCpf;
    }
  }, {
    key: "cpfFormatado",
...
/* harmony import */ var _modules_GeraCPF_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/GeraCPF.js */ "./src/modules/GeraCPF.js");
 // Estilo Css com transpilador

var btnCopiar = document.querySelector("button");
var btnRegen = document.querySelector(".regenerate");
var cpfField = document.querySelector(".cpf-gerado");
function GerarNovoCpf() {
  var geradorCpf = new _modules_GeraCPF_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  cpfField.innerHTML = geradorCpf.cpfFormatado;
}
GerarNovoCpf();
btnCopiar.addEventListener('click', function (event) {
  navigator.clipboard.writeText(cpfField.innerHTML).then(function () {
...
btnRegen.addEventListener('click', function (event) {
  GerarNovoCpf();
});
})();
